...
const pathFunctionalPrompts: Record<CareerPathKey, PromptDefinition[]> = {
  ...
  data_engineering: [
    ...
    prompt("I can design ETL or ELT workflows that are testable, observable, and recoverable.", [
      "data_engineering",
      "mlops_deployment",
    ]),
  ...
  ai_engineering: [
    prompt("I can design and deploy production-grade ML and AI services with clear SLOs.", [
      "mlops_deployment",
      "data_engineering",
      "role_mastery",
    ]),
