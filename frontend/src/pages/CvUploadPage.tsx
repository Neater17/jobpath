    ...
    <div className="space-y-8">
      <section className="rounded-[2rem] border border-white/20 bg-white/10 p-8 shadow-2xl backdrop-blur-lg">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          ...
          <h2 className="text-4xl font-bold text-white">Upload Your CV</h2>
      ...
      <section className="grid gap-8 lg:grid-cols-[1.2fr_0.8fr]">
        <div className="rounded-[2rem] border border-white/20 bg-white/10 p-8 shadow-2xl backdrop-blur-lg">
          <div className="mb-6 flex flex-wrap items-start justify-between gap-4">
            <div>
              <h3 className="text-3xl font-bold text-white">CV / Resume Reader</h3>
          ...
          <div className="mt-5 flex flex-wrap gap-3">
            ...
            <button
              ...
              className="rounded-xl border border-white/25 bg-white/10 px-6 py-3 font-semibold text-white transition hover:bg-white/20 disabled:cursor-not-allowed disabled:opacity-60"
            >
              Reset
            </button>
          </div>
        ...
        <div className="space-y-6">
          <div className="rounded-[2rem] border border-emerald-300/30 bg-gradient-to-br from-emerald-400/15 to-cyan-400/10 p-8 shadow-2xl">
            <h3 className="text-3xl font-bold text-white">How this step works</h3>
            ...
            <div className="mt-6 space-y-3 text-sm text-white/80">
              <div className="rounded-xl border border-white/15 bg-white/10 px-4 py-3">1. Upload or paste your CV content</div>
              <div className="rounded-xl border border-white/15 bg-white/10 px-4 py-3">2. We extract role and skill signals</div>
              <div className="rounded-xl border border-white/15 bg-white/10 px-4 py-3">3. Results open in a dedicated recommendation page</div>
            </div>
          </div>

          <div className="rounded-[2rem] border border-white/20 bg-white/10 p-8 shadow-2xl backdrop-blur-lg">
            <h3 className="text-2xl font-bold text-white">Best for</h3>
